...
easier, you can change all of your `svelte-modals` imports to `svelte-modals/legacy`. This is a wrapper around the new APIs to
maintain the v1 API.  This should hopefully have no breaking changes, but please report any issues you find.
